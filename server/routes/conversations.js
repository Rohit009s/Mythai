  ...
  try {
    ...
    const summary = conversations.map(conv => {
      ...
      return {
        ...
        title: conv.title || (firstUserMessage ? firstUserMessage.text.substring(0, 50) + '...' : 'New Conversation'),
        messageCount: messages.length,
        firstMessage: firstUserMessage ? firstUserMessage.text.substring(0, 120) + '...' : 'No messages yet',
